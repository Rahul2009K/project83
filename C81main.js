...
curret_position_of_mouse_x = e.clientX - canvas.offsetLeft;
curret_position_of_mouse_y = e.clientY - canvas.offsetTop;
if(mouseevent=="mousedown") {
    ctx.beginPath();
ctx.strokeStyle=color;
ctx.lineWidth=width_of_line;
ctx.moveTo(last_position_of_x, last_position_of_y);
ctx.lineTo(curret_position_of_mouse_x, curret_position_of_mouse_y);
ctx.stroke();
} 
last_position_of_x=curret_position_of_mouse_x;
last_position_of_y=curret_position_of_mouse_y;
}
